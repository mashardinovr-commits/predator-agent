...
#aandroid.permissions = INTERNET, RECORD_AUDIO, CAMERA, READ_CONTACTS, READ_SMS, RECEIVE_SMS, READ_EXTERNAL_STORAGE, WRITE_EXTERNAL_STORAGE, ACCESS_FINE_LOCATION, QUERY_ALL_PACKAGES
